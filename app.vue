  ...
  <div>
    ...
    <nav class="relative container mx-auto p-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <a
          href="#"
          class="hidden p-3 px6 py-2 text-white bg-brightRed rounded-full
    ...
    <section id="hero">
      ...
      <div class="container flex flex-col-reverse
        ...
        <div class="flex flex-col mb-32 space-y-12 md:w-1/2">
          ...
          <div class="flex jsutify-center md:justify-start">
            <a
              href="#"
              class="hidden p-3 px6 py-2 text-white bg-brightRed rounded-full
                baseline hover:bg-brightRedLight md:block"
    ...
    <section id="fearures">
      <!-- Flex container -->
      <div
        class="container flex flex-col px-4 mx-auto mt-10 space-y-12
      ...
      >
        ...
        <div class="flex flex-col space-y-12 md:w-1/2">
          ...
          <p
            class="max-w-sm text-center text-darkGrayishBlue
            md:text-left"
          >
        ...
        <div class="flex flex-col space-y-8 md:w-1/2">
          <!-- List item 1 -->
          <div
            class="flex flex-col space-y-3 md:space-y-0 md:space-x-6
            md:flex-row"
          >
            <!-- Heading -->
            <div
              class="rounded-l-full bg-brightRedSupLight
              md:bg-transparent"
            >
              <div class="flex items-center space-x-2">
                <div
                  class="px-4 py-2 text-white rounded-full md:py-1
                    bg-brightRed"
                  >
                  01
                </div>
            ...
            <div>
              ...
              <p class="text-darkGrayishBlue">
                See how your day-to-day task fit into wider vision.
    ...
    <section id="testimonials">
      ...
      <div class="max-w-6xl px-5 mx-auto mt-32 text-center">
        ...
        <div class="flex flex-col mt-24 md:flex-row md:space-x-6">
          ...
          <!-- Testimonial 2 -->
          <div
            class="hidden md:flex flex-col items-center p-6 space-y-6
              rounded-lg bg-veryLightGray md:w-1/3"
          >
        ...
        <div class="my-16">
          <a
            href="#"
            class="p-3 px6 py-2 text-white bg-brightRed rounded-full
    ...
    <section id="cta" class="bg-brightRed">
      <!-- Flex Container -->
      <div
        class="container flex flex-col items-center justify-between
          px-6 py-24 mx-auto space-y-12 md:py-12 md:flex-row md:space-y-0"
      >
        <!-- Heading -->
        <h2
          class="text-5xl font-bold leading-tight text-center
        ...
        <div>
          <a
            href="#"
            class="p-3 px6 py-2 text-brightRed bg-white rounded-full
              shadow-2xl baseline hover:bg-gray-300"
          >
            Get Started
          </a>
        </div>
    ...
    <footer class="bg-veryDarkBlue">
      <!-- Flex Container -->
      <div
        class="container flex flex-col-reverse justify-between px-6
          py-10 mx-auto space-y-8 md:flex-row md:space-y-0"
      >
        <!-- Logo and social links container -->
        <div
          class="flex flex-col-reverse items-center justify-between
        ...
        >
          ...
          <!-- Logo -->
          <div>
            <img src="@/assets/img/logo-white.svg" class="h-8" alt="" />
          </div>
          ...
          <div class="flex justify-center space-x-4">
            ...
            <!-- Link 5 -->
            <a href="#">
              <img src="@/assets/img/icon-instagram.svg" alt="" class="h-8">
            </a>
          </div>
        </div>
        <!-- List Container -->
          ...
          <form>
            <div class="flex space-x-3">
              ...
              <button
                ...
                bg-brightRed hover:bg-brightRedLight focus:outline-none"
              >
                Go
              </button>
            </div>
